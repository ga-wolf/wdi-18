...
newParagraph.innerHTML = "This was generated by JS";
// Put it on the page
  // At the end
...
newPara.innerHTML = 'This was also created by JS';
newPara.style.fontSize = "40px";
newPara.style.color = 'chartreuse';

var destination = document.querySelector(".dynamic");
destination.append( newPara );
