// UNDERSCORE - Exercises 2
// https://gist.github.com/ga-wolf/904a192f5ae50989e1fe
...
// Remember, we're not just limited to properties of objects we create - we can use this with the properties we get from the global JavaScript objects, like String.length
var sortedWords = _.sortBy(words , "length");
...
var overTwenty = _.some(words, function(word) {
...
// RUBY:  [1,2,3,4,5].sample(3);
// UNDERSCORE: _.sample([1,2,3,4,5], 3);
